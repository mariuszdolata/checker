...
public class ProxyCheckerApplication extends JFrame {
	...
	private Set<Proxies> proxiesToCheck = new HashSet<Proxies>();
	...
	public void setProxiesToCheck(Set<Proxies> proxiesToCheck) {
	...
	public ProxyCheckerApplication() {
		...
		btnPobierz.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				proxiesToCheck=AppMethods.criteriaSelectProxy(entityManagerFactory, rdbtnAllProxies, rdbtnRandomProxies, rdbtnRecentlyProxies, rdbtnGraderThanProxies, rdbtnLessThanProxies);
				panelLista.removeAll();
				panelLista.add(AppMethods.fillTable(proxiesToCheck));
				panelLista.invalidate();
			}
		});
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnZatrzymaj)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(btnStatystyka))
						.addComponent(progressBar, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 598, Short.MAX_VALUE))
					.addContainerGap())
		);
		...
		gl_panelOpcje.setHorizontalGroup(
			gl_panelOpcje.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panelOpcje.createSequentialGroup()
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelOpcje.createSequentialGroup()
							...
							.addGap(34)
							.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
								.addComponent(rdbtnHtmlUnit)
								.addComponent(rdbtnSelenium))
							.addGap(120)
							.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panelOpcje.createSequentialGroup()
									...
									.addGap(33)
									.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
										.addComponent(textNumberOfThreads, GroupLayout.PREFERRED_SIZE, 29, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_panelOpcje.createSequentialGroup()
					...
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelOpcje.createParallelGroup(Alignment.TRAILING)
							.addComponent(textXPath, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE)
							.addComponent(txtUrlToScrape, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE)
							.addComponent(textSuccess, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 502, Short.MAX_VALUE))
				...
				.addGroup(gl_panelOpcje.createSequentialGroup()
					...
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panelOpcje.createSequentialGroup()
							.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
								.addComponent(rdbtnRandomProxies)
							...
							.addGap(29)
							.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING, false)
								.addComponent(chckbxImageDisable)
								.addComponent(chckbxJSDisable)
								.addComponent(textTimeOut, GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
								.addComponent(textNumberOfRetrying, 0, 0, Short.MAX_VALUE))))
					.addContainerGap(193, Short.MAX_VALUE))
		);
		gl_panelOpcje.setVerticalGroup(
			gl_panelOpcje.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelOpcje.createSequentialGroup()
					.addContainerGap()
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panelOpcje.createSequentialGroup()
							...
							.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
									.addComponent(lblNewLabel_3)
									.addComponent(textNumberOfThreads, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))))
					...
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_1)
						.addComponent(lblNewLabel_4)
						.addComponent(textTimeOut, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(rdbtnAllProxies))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_5)
					...
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
							.addComponent(lblNewLabel_7)
							.addComponent(textNumberOfRetrying, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(rdbtnGraderThanProxies))
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(rdbtnLessThanProxies)
					.addGap(2)
					.addComponent(separator_2, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_8)
						.addComponent(txtUrlToScrape, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblNewLabel_9)
						.addComponent(textXPath, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_panelOpcje.createParallelGroup(Alignment.BASELINE)
